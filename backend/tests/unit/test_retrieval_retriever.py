...
class TestHybridRetriever:
    def test_retrieve_calls_all_pipeline_stages(self) -> None:
        ...
        with (
            ...
            asyncio.get_event_loop().run_until_complete(retriever.retrieve("test query"))
    ...
    def test_retrieve_k_override_used_for_dense_and_sparse(self) -> None:
        ...
        with (
            ...
            asyncio.get_event_loop().run_until_complete(retriever.retrieve("query", k=3))
